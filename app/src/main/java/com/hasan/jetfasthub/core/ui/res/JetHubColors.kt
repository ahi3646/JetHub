...
@Stable
class JetHubColors internal constructor(
    text: Text,
    icon: Icon,
    button: Button,
    ...
    class Text internal constructor(
        ...
        warning: Color,
        attention: Color,
        accent: Color = JetHubColorPalette.Azure,
        constantWhite: Color = JetHubColorPalette.White,
    ) {
    ...
    class Button internal constructor(
        ...
        secondary: Color,
        disabled: Color,
        positive: Color = JetHubColorPalette.Meadow,
