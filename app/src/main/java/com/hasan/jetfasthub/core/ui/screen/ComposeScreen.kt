package com.hasan.jetfasthub.core.ui.screen
...
import com.hasan.jetfasthub.core.ui.theme.AppThemeModeHolder
import com.hasan.jetfasthub.core.ui.theme.model.AppThemeMode
...
internal fun ComposeScreen.createComposeView(context: Context): ComposeView {
    return ComposeView(context).apply {
        setContent {
            ...
            JetFastHubTheme(isDarkTheme = shouldUseDarkTheme(appThemeMode)) {
