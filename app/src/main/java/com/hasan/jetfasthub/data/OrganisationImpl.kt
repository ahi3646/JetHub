...
class OrganisationImpl(private val context: Context) : OrganisationRepository {
    ...
    override suspend fun getOrganisation(token: String,organisation: String): Response<OrganisationModel> {
        return RetrofitInstance(context).gitHubService.getOrganisation(
